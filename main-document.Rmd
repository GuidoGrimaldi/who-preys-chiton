...
Few experiences in the natural world are as harrowing as being preyed upon. Predators have evolved an extraordinary variety of tools - claws to grasp, fangs to tear, beaks to pierce, and appendages or chelae to crush — in order to capture and kill their prey [@bicknell2025]. In response, prey organisms have developed an impressive array of defensive traits, including metabolic, morphological, and behavioral adaptations [@crowell2024; @barnett2025]. These include toxins, shells, spines, stingers, cryptic or warning coloration, and behaviors that reduce detection - such as mimicking inedible object like sticks, leaves, seaweed, or bird-droppings - or increasing escape success, such as alarm calls, thanatosis, or startle responses [@ruxton2018]. Given their abundance and diversity of cases, predator-prey interactions are widely regarded as classic examples of coevolutionary arms races, where reciprocal selective pressures drive adaptive changes in both predator and prey lineages over successive generations.
 
 

Ecologycally, predators play a crucial role by regulating prey population growth, shaping prey distributions, and influencing habitat use over time. Their impact often cascades through food webs, indirectly affecting other species and ecosystem functions.
Generally composed of large and more charismatic species, many conservation efforts prioritize the protection of key predatory species essential to biodiversity conservation and ecosystem stability. Counterparts, uma grande abundancia de presas é necessária para suportar a biomassa de poucos predadores. Assim When sufficient prey is unavailable, os predadores enfrentam maiores riscos de sobrevivência podendo tornar locally extinct. 



Their influence indirectly affects other populations of organisms through a cascade effect through food webs and therefore many conservation actions have as their main objective the conservation of predatory species that are key to the maintenance of ecosystems.

 For this reason, 

As relações presa-predador são comumente tidos como exemplos classicos de coevolutionary arms race, 

Together, these dynamics form the basis of predator-prey interactions, which are fundamental drivers of ecological patterns and evolutionary processes [@pringle2019; @wickman2024].

Over time, predation pode inducing genetic variation and promoting phenotypic diversity, drives adaptive radiation

Interactions between predators and prey are often
used as one of the main examples of arms races or coevolutionary process [REF].

Even though it is evolutionary, it conveys (implicated) the idea of an arms race, as interações entre espécies podem ser vistas como processos coevolutivos, onde adaptative changes in a species over generation caused by selective pressures impose a reciprocal adaptive change to other. Ao regular as populações de presas ao longo do tempo, os predadores podem inducing genetic variation and promoting phenotypic diversity, drives adaptive radiation (Bond and Kamil 2002; Nosil and Crepi 2006; Tigreros et al. 2021). Na escala do indibidual contudo a predação pode shaping prey distributions and habitat use. Together, these dynamics form the basis of predator-prey interactions, which are fundamental drivers of ecological patterns and evolutionary processes [@pringle2019; @wickman2024].



Predation is considered a powerful evolutionary force that drives adaptive radiation, . As an ecological mechanism, its effect is noticeable at different ecological scales, shaping prey distributions, habitat use, population dynamics, food webs, and ensuring the flow of energy through ecosystems (Guo et al. 2023; Johnson-Bice et al. 2023; Carroll et al. 2024; Orrick et al. 2024). 



Chitons, or polyplacophorans, are a group of marine mollusks characterized by a dorsoventrally flattened body protected by eight articulating shell plates embedded in a tough, muscular girdle [@eernisse,2007]. This flexible armor is transversed by a network of microscopic canals through which which the nervous system branches, granting chitons not only protection and mechanical versatility but also a heightened capacity for environmental sensing [@li2015; @liu2022]. This remarkably trait has been conserved since the early Cambrian (~540 million years ago) and persists in extant lineages that emerged in the early Carboniferous, ~340 million years ago [@sigwart2009; @parkhaev2017].  As such, chitons have survived major environmental shifts throughout Earth’s history, underscoring the evolutionary success of their morphological design.  

Chitons occupy a wide range of benthic habitats, from rocky intertidal zones, coral reefs, and boulder fields to rhodolith beds, seagrass meadows, and even atypical deep-sea environments such as sunken wood, whale falls, and hydrothermal vents (Kangas & Shepherd, 1984; Schwabe & Sellanes, 2004; Konar et al., 2006; Saito et al., 2008; Barros et al., 2013; Reyes-Gómez et al., 2017; Sigwart, 2017; Barboza, 2019). They feed by scraping biofilms, algae, and sediment from substrates using an iron-mineralized radula, often ingesting small invertebrates in the process (Fulton, 1975; Joester & Brooker, 2016). Ecologically, chitons play a significant role in regulating algal biomass and influence community structure by inadvertently displacing larvae and newly settled invertebrates as they move across surfaces—a phenomenon commonly referred to as "bulldozing" (Aguilera & Navarrete, 2007, 2012; Aguilera et al., 2015; Liversage & Kotta, 2019).

Given their widespread distribution, ecological relevance, and the apparent sophistication of their defenses, one might expect chitons to be well-studied in the context of predator-prey interactions. However, detailed knowledge of their natural predators remains surprisingly limited. Most existing literature has focused on their anatomy, developmental biology, and ecological functions, while direct observations of predation, predator identities, and attack strategies are scarce and often anecdotal. This knowledge gap hinders a full understanding of the effectiveness of chiton defenses and the selective pressures that have shaped their long evolutionary history.
...
A total of 88 documents were written by 160 authors affiliated with 153 institutions across 32 countries. These works were published in 62 distinct journals, with  research articles comprising the vast majority (93.18%). The research efforts were supported by 13 different funding sponsors. Most studies (n=30) rely on indirect methods such as analyzing stomach or gut content, regurgitation pellets, fecal samples, metabarcoding, drill holes (boreholes), or prey remain. Studies reporting direct interactions (n=8) typically occur under limited or artificial condition, such as prey choice experiments in laboratory or natural settings. Direct observations of *in situ* predator-prey interactions are most commonly documented in starfish studies.
