...
Chitons are eight-plated mollusks that have thrived in oceans worldwide for at least 540 million years. They play a key ecological role by regulating populations of algae, invertebrates, and other components of marine communities. Despite their ecological importance, chitons remain largely unknown to the general public, and information on their predators is notably scarce - even in major invertebrate biology textbooks. In this study, we review the scientific literature to identify the main taxonomic groups that prey on chitons, detailing predator-prey species interactions and the methods used to identify them. Additionally, we report the first field record of an interaction between a juvenile Brazilian reef octopus (*Octopus insularis*) and the endemic West Atlantic chiton *Ischnoplax pectinata* - a relationship previously undocumented in the scientific literature. Our survey reveals a diverse array of invertebrate and vertebrate predators, including mammals, birds, fish, sea stars, lobsters, crabs, octopuses, sea snails, and polychaetes. Most predation events were recorded through manipulative experiments or inferred indirectly, with few studies documenting interactions in natural habitats. Chitons are notoriously challenging to prey upon due to their mineralized shells and their strong adhesion to hard substrates. To overcome these defenses, predators employ different foraging and prey-handling strategies based on their own traits and the characteristics of their prey and habitat. Understanding predator-prey relationships is critical for mapping trophic interactions and food web dynamics, including energy flow and nutrient cycling. This help us to refining ecological models and forecasting system responses to environmental changes such as climate shifts, habitat loss, or species invasion, enabling informing ecosystem management and restoration planning. 

**KEYWORDS:** Borehole, Boulders, Cephalopoda, Drill hole, Intertidal reefs, *Ischnoplax pectinata*, Mollusca, Polyplacophora.

# INTRODUCTION

Few experiences in nature are as harrowing as being preyed upon. Predators have evolved an extraordinary variety of tools - claws to grasp, fangs to tear, beaks to pierce, and appendages or chelae to crush — in order to capture and kill their prey [@bicknell2025]. In response, preys have developed an impressive array of defensive adaptations - metabolic, morphological, and behavioral - that help them avoid being attacked or killed [@crowell2024; @barnett2025]. These defenses include toxins, shells, spines, stingers, aposematic or cryptic coloration, and behaviors such as mimicking inedible object (e.g. sticks, leaves, seaweed, or bird-droppings) or employing escape responses such as alarm calls, thanatosis, or startle responses [@ruxton2018]. Predator and prey species are so deeply intertwined that their relationship often evolves through coevolution or an evolutionary arms race, where reciprocal selective pressures drive adaptive changes in both lineages over generations [REF]. Ecologically, predators plays a critical role in regulating prey populations, shaping their distribution, and influencing their reproductive strategies, behavior and habitat use [REF]. Conversely, maintaining a viable predator population requires an abundant and diverse prey base, which in turn influences the predator’s spatial distribution and ecological niche [REF]. Together these dynamics regulate the structure of food webs, triggering cascading effects that influence the abundance, behavior, and distribution of multiple species, as well as ecological processes such as productivity, nutrient cycling, and overall ecosystem stability [REF]

Chitons, or polyplacophorans, are a group of marine mollusks characterized by a dorsoventrally flattened body protected by eight articulating shell plates embedded in a tough, muscular girdle [@eernisse,2007]. This flexible armor is traversed by a network of microscopic canals through which the nervous system branches, granting not only structural protection and movement versatility but also a enhanced environmental sensing [@li2015; @liu2022]. This remarkably shell-armature has remained largely unchanged since the early Cambrian (ca. 540 Mya) and continues in extant lineages that emerged in the early Carboniferous ca. 340 mya  [@sigwart2009; @parkhaev2017]. As a result, chitons have persisted through major climatic and geological transitions throughout Earth’s history [@wanninger2019]. These mollusks inhabit a broad range of intertidal and subtidal benthic habitats, including rocky shores, coral reefs, boulder fields, pebbles, rhodolith beds, and seagrass meadows [REF]. They are also found in more atypical deep-sea environments such as sunken wood, whale falls, and hydrothermal vents (Kangas & Shepherd, 1984; Schwabe & Sellanes, 2004; Konar et al., 2006; Saito et al., 2008; Barros et al., 2013; Reyes-Gómez et al., 2017; Sigwart, 2017; Barboza, 2019). Chitons feed by scraping algae or biofilms from hard surfaces using an iron-mineralized radula, ocasionally ingesting small invertebrates and sediments in the process (Fulton, 1975; Joester & Brooker, 2016). Though their feed activity, chitons help regulate algal biomass and influence community structure, often displacing larvae and newly settled invertebrates as they move — a process known as "bulldozing effect" (Aguilera & Navarrete, 2007, 2012; Aguilera et al., 2015; Liversage & Kotta, 2019). 

Small details can easily go unnoticed, much like chitons, which are often overlooked by the general public—likely due to their small size, morphology and cryptic behavior. They are typically negatively phototactic, seeking refuges in crevices, holes, or beneath rocks during daylight [@miller2000; @vermeiren2014; @montes2021]. These small animals have curioso homing behaviour, frequentemente retornando ao seus home sites após forrageio [REF]. Assim, eles are commonly observed crawling and feeding along the vertical sides of rock, boulders and others substrates (Jörger et al. 2008; Liversage & Benkendorff, 2017) (Demopulos, 1975; Kangas & Shepherd, 1984; Cretchley et al. 1997). These activity patterns are complex, influenced by tidal and non-tidal rhythms, including the day-night cycle, season changes, and broad climate conditions (Glynn 1970; Ng and Williams 2006; Yoshioka and Fujitani 2006), and varying among habitats and species [REF]. Biologically, these behaviors are thought to help mitigate physiological stress caused by solar radiation, high temperatures, and desiccation, contributing to their survival in exposed intertidal environments (Shick 2007). Additionally, remaining hidden during the day likely provides ecological protection from visually oriented predators (Schmitt 1982; Rodrigues and Absalão 2005). Este ainda é um campo aberto para investigação. Aparentemente, as "cores" parecem não afetar a reconhecimento de certos predadores. Surprisingly, details on organisms that prey on chitons is scarce and fragmented. Major invertebrate biology textbooks make little to no mention of them as prey (Brusca et al. 2023). Chiton's research has focused on their morphology, developmental biology, behavior and ecological role, while direct information about their predators, taxonomic groups, species targed, and hunting strategies remain limited and scattered across scientific literature. 

Understanding predator-prey relationships is critical for mapping trophic interactions and deciphering food web dynamics, including energy flow and nutrient cycling. Identifying key predators is essential for refining ecological models and forecasting system responses to environmental changes such as climate shifts, habitat loss, or species introductions. This could supports conservation efforts by enabling better biodiversity monitoring, the detection of invasive species, and informed ecosystem management and restoration planning. Here, we present a literature review on predator-prey interactions involving chitons, identifying which species preys on them. We adopt a broad definition of *predation* as any interaction in which a organism consume another. For each documented case, we details the predator species, the chiton species targeted, and the context in which the interaction was observed. In addition, we report the first field field record of a juvenile Brazilian reef octopus (*Octopus insularis*) preying on the endemic West Atlantic chiton *Ischnoplax pectinata* - an interaction previously unrecorded in the scientific literature.
...
A total of 88 documents were authored by 160 researchers affiliated with 153 institutions across 32 countries. These works were published in 62 distinct journals, with research articles comprising the vast majority (93.18%). Sixty-five years of research efforts were supported by 13 different funding agencies. Most studies (n=39) focus on the diets of other animals, in which chitons are merely one of several prey items. A significant number of studies (n=30) rely on indirect methods such as analysis of stomach or gut content, regurgitated pellets, fecal samples, boreholes, prey remains, or metabarcoding. Studies reporting direct interactions (n=8) typically occur under limited or artificial conditions, such as prey choice experiments conducted in laboratory or semi-natural settings. Direct *in situ* observations of animals preying upon chitons are rare and most frequently documented in studies involving starfish.
...
ftA <- as_grouped_data(table1, groups = c("Animals"))
ft <- flextable(ftA)
ft <- add_footer_lines(ft, "1. Taylor (1983); 2. Louda (1979); 3. Wodinsky (1969); d) Pilson and Taylor (1961); e) Ambrose (1984); f) Dantas et al. (2020); g) Mather and Nixon (1990); h) Cortez et al. (1998); i) Simonini et al. (2018); j) Silva et al. (2010a); k) Mendonça et al. (2016); l) m) n) o) p) q).")

ft <- color(ft, part = "footer", color = "#666666")
ft <- set_caption(ft, caption = as_paragraph(
                               as_b("Table 1: "), "Studies reporting chiton predators. The scientific names were used according to the currently accepted nomenclature in WoRMS. In table footnote, boulder chitons and their respective studies.")
)
...
In this study, we compile information on predator species and animal groups that prey on chitons, the specific chiton species targeted, and the contexts in which these interactions occur. The primary predators identified include polychaetes, sea snails, octopuses, crabs, lobsters, sea stars, fishes, seabirds, and sea otters. We also report a new field observation of a juvenile Brazilian reef octopus (*Octopus insularis*) preying on the endemic West Atlantic chiton *Ischnoplax pectinata*. Brazilian reef octopuses are a common predator on intertidal reefs in northeastern Brazil [REF]. Although this species is known to consume chitons (Dantas et al. 2020), they are typically considered opportunistic prey, with the octopus's diet being dominated by small crustaceans, bivalves, and gastropods (Batista and Leite 2016; Leite et al. 2016). To our knowledge, this is the first documented interaction between *O. insularis* and *I. pectinata* in the scientific literature.

In our survey, we identified only four studies that report direct observations of chiton predation in natural habitats. These studies primarily focus on sea stars, which typically feed by everting their stomachs over their prey, secreting digestive enzymes, and absorbing the partially digested material (Brusca et al. 2022). In the case of sea otters, Johnstone *et al*. (2024) documented foraging behavior through binoculars observations. Chelazzi *et al*. (1983) mention the fish *Arothron immaculatus* and the crabs *Ozius guttatus* and *Eriphia smithii* as important predators of *Acanthopleura gemmata*, although they do not clearly indicate the source of this information.In contrast, the remaining studies reported chiton predation only through manipulative experiments or indirect methods such as analyses of stomach or gut contents, regurgitation pellets, drill holes, stable isotopes, or prey remains. These findings underscore the difficulty of observing predation events directly in wild (Smith and Ruxton 2020). This challenge  is especially evident with invertebrates, whose concealment and behavior often hinder detection, requiring substantial effort and financial resources for reliable observations (Sunderland 1988; Birkhofer et al. 2017). Even in studies of octopuses—where visual searches and in situ diving are frequently employed—predation events are rarely recorded under natural conditions (Leite et al. 2009a, 2016). In such contexts, opportunistic observations can provide valuable insights into the nature of predator-prey interactions.
...
# Fragmentos soltos
 ...
 Study with chitons species trouxeram importantes avanços para campos da optica, mechanica, e desing de materiais. Despite this, chitons remain relatively unfamiliar to the general public,

and even for the scientific community. Information about chiton ecology is scarce, specially about their inter-specific relationships, and even details about their predators are notably absent from major undergraduate invertebrate biology textbooks.

, and even for the scientific community
 
 Fish may peck or bite, birds deliver sharp jabs with their beaks, crabs use their claws to grip and crush, and sea snails drill hole into their prey’s shells. Octopuses combine tactics similar to those of crabs and snails.
 
 Their shells form a biomineralized armor embedded with sensory system that contribute to both mechanical defense and behavioral adaptability.

Predation is considered a powerful evolutionary force that drives adaptive radiation, inducing genetic variation and promoting phenotypic diversity (Bond and Kamil 2002; Nosil and Crepi 2006; Tigreros et al. 2021). As an ecological mechanism, its effect is noticeable at different ecological scales, shaping prey distributions, habitat use, population dynamics, food webs, and ensuring the flow of energy through ecosystems (Guo et al. 2023; Johnson-Bice et al. 2023; Carroll et al. 2024; Orrick et al. 2024). 

Being preyed upon may be the most tearing fate an individual can face in its life. Predadores podem se utilizar de presas, garras e um série de estruturas que evolutivamente se especializaram em prender, rasgar, dilacerar e matar sua presa. Diante do perigo eminente, presas por sua vez desenvolveram estruturas morfologicas como conchas, espinhos, chifres e colorações, bem como estratégias comportamenmtais, para prevenir a detecção ou se defender de seus predadores.


Avoiding predation is therefore critical to individual's fitness (Palmer and Packer 2021).

Evolution offers remarkable examples of how natural selection has shaped strategies for organisms to prevent predator detection or defend themselves after being detected (Ruxton et al. 2018). 

The former associate phenotypical variations, such as color patterns, transparency, and morphological outgrowths, with behavioral changes that help organisms avoid detection or be misidentified as an inedible object like sticks, leaves, seaweed, or bird-droppings (Arias et al. 2019; Cuthill 2019; Stevens and Ruxton 2019).

Additionally, the latter make organisms unprofitable for predators, such as developing spines, stingers, toxins, or even warning signals (Ruxton et al. 2018). 

In this way, the presence of predators in a given community can force prey to make behavioral choices between vital activities, such as feeding, and avoiding contact with predators by reducing activity or seeking refuge (Chauhan et al. 2024; Liao et al. 2024)
...
Given their abundance and diversity of cases, predator-prey interactions are widely regarded as classic examples of coevolutionary arms races, where reciprocal selective pressures drive adaptive changes in both predator and prey lineages over generations.
-------
