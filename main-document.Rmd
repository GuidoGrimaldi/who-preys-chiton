...
Few experiences in the natural world are as harrowing as being preyed upon. Predators have evolved an extraordinary variety of tools - claws to grasp, fangs to tear, beaks to pierce, and appendages or chelae to crush — in order to capture and kill their prey (@bicknell2025). In response, prey organisms have developed an impressive array of defensive traits, including metabolic, morphological, and behavioral adaptations (@crowell2024; @barnett2025). These include toxins, shells, spines, stingers, cryptic or warning coloration, and behaviors that reduce detection - such as mimicking inedible object like sticks, leaves, seaweed, or bird-droppings - or increasing escape success, such as alarm calls, thanatosis, or startle responses (@speed2012; @ruxton2018). Together, these dynamics form the basis of predator-prey interactions, which are fundamental drivers of ecological patterns and evolutionary processes (@pringle2019; @wickman2024).

Chitons, or polyplacophorans, are a group of marine mollusks characterized by a  dorsoventrally flattened body protected by eight articulating shell plates embedded in a tough, muscular girdle (). This flexible armor is transversed by a network of microscopic canals through which which the nervous system branches, granting chitons not only protection and mechanical versatility but also a heightened capacity for environmental sensing. This remarkably trait has been conserved since the early Cambrian (~540 million years ago) and persists in extant lineages that emerged in the early Carboniferous (~340 million years ago).  As such, chitons have survived major environmental shifts throughout Earth’s history, underscoring the evolutionary success of their morphological design.  
