...
**Acknowledgements:** GG thank Professor Jennifer Mather, Graduate Program of Ecology (UFSC), and CAPES. PP thanks, CAPES, CNPq and FAPESC, as well Rede Clima, Coral Vivo and REBENTOS. A Researcher Scholarship was granted to DMAP by
CNPq. We are also grateful to the anonymous reviewer for their constructive comments, which helped improve the quality of this manuscript. This study was financed in part by the Coordenacao de Aperfeicoamento de Pessoal de Nivel Superior – Brasil (CAPES) (88887.497855/2020-00)
...
**Funding:** GG was supported by a doctoral scholarship (88887.497855/2020-00) from the Coordination for the Improvement of Higher Education Personnel (CAPES).
