...
Chitons are eight-shelled mollusks that has thrived in oceans worldwide for at least 540 million years. They play a crucial ecological role in regulating populations of algae, invertebrates, and others marine communities. Despite this, chitons remain relatively unfamiliar to the general public. Information about chitons is scarce, specially about their inter-specific relationships, and biological details. Information about what kind of animal preys on chitons are notably absent even in the major undergraduate invertebrate biology textbooks. In this study, we review the scientific literature to identify the main groups of animals that prey on chitons, specifying the prey and predator species, and specify the method of observation nos quais tais interaçoes ocorreram. Additionally, we present the first field record of an interaction between a juvenile Brazilian reef octopus, *Octopus insularis*, and the endemic West Atlantic chiton *Ischnoplax pectinata*, uma interação ainda não specificada para as especies. Our survey identified mammals, birds, fish, starfish, lobsters, crabs,  octopuses, sea snails, and polychaetes as the primary predators of chitons. Predation was predominantly observed in manipulative experiments or inferred through indirect methods, with few studies documenting predation in natural habitats.

Chitons are notoriously difficult to prey upon due to their strong attachment to hard substrates, especially when disturbed. Predators can use different foraging and prey-handling strategies based on their own traits and the specific characteristic of their prey and habitat.

In this context, the Brazilian reef octopuses’ juveniles emerge as prominent predators in intertidal reefs in northeastern Brazil. Our field observation of an octopus preying on a chiton beneath boulders challenges the assumption that hiding under boulders provides a reliable protection from predators. Despite being preyed upon by a wide range of predators, chitons have thrived evolutionary. Understanding the interactions between cryptic species, like octopuses and chitons, is essential for understanding the structure, dynamics, and vulnerabilities of tropical reef ecosystems. This knowledge is important for guiding conservation and management efforts in boulder reef systems amid the challenges posed by climate change and biodiversity loss.
